...
(function (a) {
    ...
    a.paramquery.tableToArray = function (h) {
        ...
        b.find("th,td").each(function (p, m) {
            ...
            var o = {title: r, width: k, dataType: s, align: q, dataIndx: p};
            c.push(o)
        });
    ...
    a.paramquery.formatCurrency = function (h) {
        ...
        var c = h.length;
        var e = h.substring(0, c - 2), g = h.substring(c - 2, c), b = e.match(/\d/g).reverse(), d = [];
...
(function (b) {
    ...
    a._refreshPage = function () {
        ...
        this.page = b("<input type='text' tabindex='0' />").replaceAll("span.textbox", e).bind("change", function (h) {
            var i = b(this);
            var j = i.val();
            if (isNaN(j) || j < 1) {
            ...
            if (d._trigger("change", h, {curPage: j}) !== false) {
                d.option({currentPage: j})
            } else {
                i.val(d.options.currentPage);
                return false
            }
...
(function (b) {
    var a = {};
    a.options = {length: 200, num_eles: 3, cur_pos: 0, timeout: 350, pace: "optimum", direction: "vertical"};
    a._destroy = function () {
    ...
    a._create = function () {
        ...
        this.element.disableSelection().bind("click.pq-scrollbar", function (i) {
        ...
        }).bind("mouseup mouseout", function (h) {
            if (e.options.disabled) {
                return
            }
            e._mouseup(h)
    ...
    a.scroll = function (c) {
        var d = this.options;
        this._trigger("scroll", c, {cur_pos: d.cur_pos, num_eles: d.num_eles})
    };
    a._setOption = function (c, d) {
        if (c == "disabled") {
            if (d == true) {
...
(function (h) {
    ...
    d._generateTables = function (m) {
        var t = this.that, z = t.colModel, I = z.length, y = t.options, G = y.columnBorders, q = y.rowBorders, A = y.scrollModel, v = t.outerWidths;
        t._bufferObj_calcInitFinal();
        var s = (m) ? 0 : t.init, o = (m) ? m.data.length - 1 : t["final"], H = (m && m.data) ? m.data : t.data, r = t.getRowIndxOffset();
        if (!m && (s == null || o == null)) {
            t.$cont.empty();
            t.$tbl = null;
            return
        ...
        if (!m) {
            t._trigger("beforeTableView", null, {data: t.data, curPos: s, finalPos: o, curPage: t.dataModel.curPage})
        }
        var F = "pq-grid-cell ";
        if (!y.wrap || m) {
            F += "pq-wrap-text "
        ...
        this.offsetRow = null;
        do {
            var j = H[s], x = j, w = s, E = x.hidden, i = "";
            if (E) {
                if (s == o) {
                    break
                }
        ...
        if (!A.scrollTillLastRow) {
            h.measureTime(function () {
                ...
                if (m) {
                    ...
                    if (K == -1) {
                        t.tables.push({$tbl: M, cont: m.$cont[0]})
                    } else {
                        t.tables[K].$tbl = M
                    }
                } else {
        ...
        if (!m) {
            window.setTimeout(function () {
                t._fixTableViewPort();
                t._trigger("refresh", null, {dataModel: t.dataModel, data: t.data, initV: t.init, initH: t.initH})
            }, 0)
        }
    };
    d._renderCell = function (v) {
        var p = this.that, i = v.rowIndxPage, o = v.rowIndx, m = v.rowData, l = v.colIndx, k = v.$td, n = v.column, q = n.dataIndx, j = v.wrap, u = v.customData;
        var t;
        if (n.render) {
            t = n.render({
                data: p.data,
    ...
    d._generateRow = function (r, q, x, I, y, n, F, B, j) {
        var s = "pq-grid-row";
        var p = this.that, u = p.options, G = u.columnBorders, t = u.wrap, D = u.customData;
        var E = {rowIndx: q + n, rowIndxPage: q, rowData: r, wrap: t, customData: D};
    ...
    b._addToData = function (i) {
        ...
        var m = (j == "remote") ? this.that.data : this.options.dataModel.data, k = (j == "remote") ? i.rowIndxPage : i.rowIndx, l = m[k];
        l.selectedRow = true
    };
    b.setDirty = function () {
    ...
    b.removeAll = function (k) {
        ...
        var o = k.raiseEvent, n = this.that, q = (k.offset == null) ? n.getRowIndxOffset() : obj.offset;
        var p = this.selectedRows.slice(0);
        for (var l = 0; l < p.length; l++) {
            var j = p[l];
            var m = j.rowIndx;
            this.remove({rowIndx: m, offset: q})
        }
    };
    b.refresh = function () {
        this.selectedRows = [];
        ...
        for (var k = 0, j = m.length; k < j; k++) {
            var l = m[k];
            if (l.selectedRow) {
                this.selectedRows.push({rowIndx: k})
            }
        }
        this.isDirty = false
    };
    b.replace = function (m) {
        ...
        var l = m.rowIndx, n = m.offset = (m.offset == null) ? this.that.getRowIndxOffset() : m.offset, i = m.rowIndxPage = l - n, k = m.$tr, j = m.evt;
    ...
    b.add = function (t) {
        ...
        var m = t.rowIndx, p = this.that, l = (t.offset == null) ? p.getRowIndxOffset() : t.offset, i = t.rowIndxPage = m - l, o = t.$tr, s = t.evt, k = this.selectedRows, j = this.isSelected(t);
        if (j == null) {
            return false
        } else {
            if (this.isSelected(t) == false) {
                var q = this._boundRow(t), o = q;
                k.push({rowIndx: m});
                this._addToData(t);
                p._trigger("rowSelect", s, {rowIndx: m, rowIndxPage: i, data: p.data, dataModel: p.dataModel, $tr: o})
            } else {
    ...
    b.remove = function (r) {
        ...
        var l = r.rowIndx, o = this.that, k = (r.offset == null) ? o.getRowIndxOffset() : r.offset, i = r.rowIndxPage = l - k, p = r.evt, q = (o.init + k - o.offsetRow), j = (o["final"] + k - o.offsetRow);
        if (this.isSelected(r)) {
            var n = o.getRow({rowIndxPage: i});
            if (n) {
                n.removeClass("pq-row-select ui-state-highlight")
            }
            o._trigger("rowUnSelect", p, {rowIndx: l, dataModel: o.dataModel, $tr: n});
    ...
    b.indexOf = function (m) {
        ...
        var k = m.rowIndx, l = this.selectedRows;
    ...
    b._boundRow = function (m) {
        var i = m.rowIndxPage, l = m.rowIndx, k = this.that, j = (m.$tr == null) ? k.getRow({rowIndxPage: i}) : m.$tr;
    ...
    var a = function (i) {
        this.options = i.options, this.that = i, this.selectedCells = []
    };
    var g = a.prototype;
    ...
    g.removeAll = function (r) {
        ...
        var j = r.raiseEvent, o = this.that, k = (r.offset == null) ? o.getRowIndxOffset() : obj.offset;
        var q = this.selectedCells.slice(0);
        for (var m = 0; m < q.length; m++) {
            var n = q[m];
            var l = n.rowIndx, p = n.dataIndx;
            this.remove({rowIndx: l, offset: k, dataIndx: p})
        }
    };
    g.isSelected = function (i) {
        ...
        var j = this.options.dataModel.location;
        var m = this.that, o = (j == "remote") ? m.data : this.options.dataModel.data, l = (j == "remote") ? i.rowIndxPage : i.rowIndx, k = (i.dataIndx == null) ? m.colModel[i.colIndx].dataIndx : i.dataIndx, n = o[l];
        if (n == null) {
            return null
        }
    ...
    g.refresh = function () {
        ...
        for (var k = 0, j = m.length; k < j; k++) {
            ...
            if (l.selectedIndices && l.selectedDataIndices[dataIndx]) {
                this.selectedCells.push({rowIndx: k, dataIndx: dataIndx})
            }
        }
        this.isDirty = false
    };
    g.replace = function (m) {
        ...
        var k = m.rowIndx, l = m.colIndx, o = m.offset = (m.offset == null) ? this.that.getRowIndxOffset() : m.offset, i = m.rowIndxPage = k - o, n = m.$td, j = m.evt;
        this.removeAll({raiseEvent: true});
        this.add(m)
    };
    g.add = function (u) {
        ...
        var n = u.rowIndx, p = this.that, m = (u.offset == null) ? p.getRowIndxOffset() : u.offset, i = u.rowIndxPage = n - m, l = u.colIndx = (u.colIndx == null) ? p.getColIndxFromDataIndx(u.dataIndx) : u.colIndx, q = u.dataIndx = (u.dataIndx == null) ? p.colModel[l].dataIndx : u.dataIndx, t = u.evt, s = this.selectedCells, k = this.isSelected(u);
        if (k == null) {
            return false
        } else {
            if (k == false) {
                var j = p.getCell({rowIndxPage: i, colIndx: l});
                if (j) {
                    j.addClass("pq-cell-select ui-state-highlight")
                }
                s.push({rowIndx: n, dataIndx: q});
                this._addToData(u);
    ...
    g.remove = function (t) {
        ...
        var n = t.rowIndx, p = this.that, q = (t.dataIndx == null) ? p.colModel[t.colIndx].dataIndx : t.dataIndx, k = (t.colIndx == null) ? p.getColIndxFromDataIndx(q) : t.colIndx, m = (t.offset == null) ? p.getRowIndxOffset() : t.offset, i = t.rowIndxPage = n - m, r = t.evt, s = (p.init + m), l = (p["final"] + m);
        if (this.isSelected(t)) {
            var j = p.getCell({rowIndxPage: i, colIndx: k});
            if (j) {
                j.removeClass("pq-cell-select ui-state-highlight")
            }
            p._trigger("cellUnSelect", r, {rowIndx: n, colIndx: k, dataIndx: q, dataModel: p.dataModel, $td: j});
    ...
    g.indexOf = function (p) {
        ...
        var o = p.rowIndx, n = this.that, k = p.dataIndx = (p.dataIndx == null) ? n.colModel[p.colIndx].dataIndx : p.dataIndx;
    ...
    f._findCellFromEvtCoords = function (t) {
        if (this.$tbl == null) {
            return {$td: null, rowIndxPage: null, colIndx: null}
        }
        ...
        return {$td: l, rowIndxPage: k, colIndx: o}
    };
    f._rangeSelectRow = function (l, o, q) {
        var n = this, p = n.sRows.getSelection(), j = p.slice(0);
        for (var m = 0; m < j.length; m++) {
            var k = j[m], r = k.rowIndx;
            if (r < l || r > o) {
                n.sRows.remove({rowIndx: r})
            }
        }
        for (var r = l; r <= o; r++) {
            n.sRows.add({rowIndx: rowIndx})
        }
    };
    f._rangeSelect = function (q, n, u, r, v) {
        var s = this, k = s.sCells.getSelection(), m = k.slice(0);
        for (var p = 0; p < m.length; p++) {
            var o = m[p], w = o.rowIndx, t = o.dataIndx, j = this.getColIndxFromDataIndx(t);
            if (w < q || w > u) {
                s.sCells.remove({rowIndx: w, colIndx: j, dataIndx: t})
            } else {
                if (w == q && j < n) {
                    s.sCells.remove({rowIndx: w, colIndx: j, dataIndx: t})
                } else {
            ...
            do {
                if (w == q && j < n) {
                    ...
                    if (w == u && j > r) {
                        ...
                        s.sCells.add({rowIndx: w, colIndx: j, dataIndx: t})
                    }
                }
                w++
            } while (w <= u)
    ...
    f._blockSelect = function (q, n, u, r, v) {
        ...
        for (var p = 0; p < m.length; p++) {
            var o = m[p], w = o.rowIndx, t = o.dataIndx, j = this.getColIndxFromDataIndx(t);
            if (j < n || j > r) {
                s.sCells.remove({rowIndx: w, dataIndx: t, colIndx: j})
            } else {
                if (w < q || w > u) {
                    s.sCells.remove({rowIndx: w, dataIndx: t, colIndx: j})
                }
    ...
    f._create = function () {
        ...
        this.$cont.on("click", function (n) {
            return l._onClickCont(n)
        });
        this.$cont.on("click", ".pq-tree-expand-icon", function (n) {
            return l.cTreeView._onClickTreeExpandIcon(n)
        });
        this.$cont.on("click", "td.pq-grid-cell", function (n) {
            return l._onClickCell(n)
        });
        this.$cont.on("click", "tr.pq-grid-row", function (n) {
            return l._onClickRow(n)
        });
        this.$cont.on("dblclick", "td.pq-grid-cell", function (n) {
            return l._onDblClickCell(n)
        });
        this.$cont.on("dblclick", "tr.pq-grid-row", function (n) {
            return l._onDblClickRow(n)
        });
        this.$cont.on("mouseenter", "td.pq-grid-cell", function (n) {
            var o = h(this);
            if (l._trigger("cellMouseEnter", n, {$td: o, dataModel: l.options.dataModel}) == false) {
                return false
            }
        ...
        this.$cont.on("mouseenter", "tr.pq-grid-row", function (n) {
            var o = h(this);
            if (l._trigger("rowMouseEnter", n, {$tr: o, dataModel: l.options.dataModel}) == false) {
                return false
            }
        ...
        this.$cont.on("mouseleave", "td.pq-grid-cell", function (n) {
            var o = h(this);
            if (l._trigger("cellMouseLeave", n, {$td: o, dataModel: l.options.dataModel}) == false) {
                return false
            }
            if (l.options.hoverMode == "cell") {
                l.unHighlightCell(o)
        ...
        this.$cont.on("mouseleave", "tr.pq-grid-row", function (n) {
            var o = h(this);
            if (l._trigger("rowMouseLeave", n, {$tr: o, dataModel: l.options.dataModel}) == false) {
                return false
            }
            if (l.options.hoverMode == "row") {
                l.unHighlightRow(o)
        ...
        this.$cont.bind("mousewheel DOMMouseScroll", function (n) {
        ...
        if (window.opera) {
            this.$grid_inner.bind("keypress.pq-grid", {that: this}, function (n) {
                l.keyPressDown(n)
            })
        } else {
            this.$grid_inner.bind("keydown.pq-grid", {that: this}, function (n) {
                l.keyPressDown(n)
            })
        }
    ...
    f._onDblClickCell = function (j) {
        ...
        var i = n.rowIndxPage, o = l.getRowIndxOffset(), k = i + o, m = n.colIndx;
        ...
        if (this.isEditableCell({colIndx: m}) && l.options.editModel.clicksToEdit > 1) {
            l._setSelection(null);
            if (l.options.selectionModel.type == "cell") {
                l._setSelection({rowIndx: k, colIndx: m})
            } else {
                if (l.options.selectionModel.type == "row") {
                    l._setSelection({rowIndx: k})
                }
            }
            l._editCell(p)
        }
    ...
    f._onClickRow = function (x) {
        ...
        var j = parseInt(t.attr("pq-row-indx")), o = u.getRowIndxOffset(), p = j + o;
        var z = {rowIndx: p, evt: x};
        if (u._trigger("rowClick", x, {$tr: t, rowIndxPage: j, rowIndx: p, dataModel: u.options.dataModel}) == false) {
            return false
        }
            ...
            if (w.length > 0) {
                if (x.ctrlKey && k.mode != "single") {
                    ...
                    if (x.shiftKey && k.mode != "single") {
                        var n = w[w.length - 1], l = n.rowIndx, r = l, v = p;
                        if (l > p) {
                            r = p;
                            v = l
                        }
                        ...
                        for (var q = 0; q < m.length; q++) {
                            var s = m[q], y = s.rowIndx;
                            if (y < r || y > v) {
                                u.sRows.remove({rowIndx: y, evt: x})
                            }
                        }
                        for (var y = r; y <= v; y++) {
                            u.sRows.add({rowIndx: y, evt: x})
                        }
                        u._setSelection(z)
                    } else {
                        u.sRows.removeAll({raiseEvent: true});
                        u._setSelection(z)
                    }
                }
            } else {
    ...
    f._onDblClickRow = function (k) {
        ...
        var j = parseInt(m.attr("pq-row-indx")), o = n.getRowIndxOffset(), l = j + o;
        var i = {rowIndx: l, evt: k};
    ...
    f.isEditableCell = function (l) {
        var k = l.colIndx, j = (l.column == null) ? (this.colModel[k]) : l.column, i = true;
    ...
    f._onClickCell = function (t) {
        var n = this, q = this.options, x = q.selectionModel;
        var m = h(t.currentTarget);
        var j = n.getCellIndices(m);
        var i = j.rowIndxPage, l = n.getRowIndxOffset(), o = j.rowIndx = i + l, w = j.colIndx, s = j.dataIndx = this.colModel[w].dataIndx, k = n.colModel[w];
        j.evt = t;
        ...
        if (this.isEditableCell({column: k}) && q.editModel.clicksToEdit == "1") {
            n._setSelection(null);
            if (x.type == "cell") {
                n._setSelection(j)
            } else {
                n.bringRowIntoView({rowIndxPage: i});
                m = n._bringCellIntoView({rowIndxPage: i, colIndx: w})
            }
            window.setTimeout(function () {
                n.editCell(j)
            }, 0);
            ...
            if (r.length > 0) {
                if (t.ctrlKey && x.mode != "single") {
                    ...
                    if (t.shiftKey && x.mode != "single") {
                        var A = r[r.length - 1], p = A.rowIndx, v = n.getColIndxFromDataIndx(A.dataIndx), u = p, z = o, y = v, B = w;
                        if (p > o) {
                            u = o;
                            z = p
                        }
                        ...
                        n.sCells.removeAll({raiseEvent: true});
                        n._setSelection(j)
                    }
                }
            } else {
    ...
    f._getCreateEventData = function () {
        return {dataModel: this.options.dataModel, data: this.data, colModel: this.options.colModel}
    };
    ...
    f._initPager = function () {
        ...
        var j = this;
        var k = {
            rPP: i.rPP, rPPOptions: i.rPPOptions, change: function (l, n) {
    ...
    f._refreshDataFromDataModel = function () {
        var k = this.options, j = k.dataModel;
            ...
            success: function (o, s, q) {
                ...
                if (typeof i.getData == "function") {
                    ...
                    if (i.sorting == "local" && i.sortIndx != undefined) {
                        k._refreshSortingDataAndView({sorting: true})
                    } else {
                ...
                k.hideLoading();
                k.loading = false;
                k._trigger("load", null, {dataModel: k.options.dataModel, data: k.data});
    ...
    f._refreshDraggable = function () {
        if (this.options.draggable) {
            ...
            this.element.draggable({
                handle: this.$title, start: function (i, j) {
                }
            })
        } else {
            this._destroyDraggable()
    ...
    f._refreshResizable = function () {
        ...
        if (this.options.resizable) {
            this.element.resizable({
                helper: "ui-state-highlight", delay: 0, start: function (j, k) {
                    h(k.helper).css({opacity: 0.5, background: "#ccc", border: "1px solid steelblue"})
                }, resize: function (j, k) {
                }, stop: function (j, k) {
    ...
    f.refreshSortingDataAndView = function () {
        this._refreshSortingDataAndView({sorting: true})
    };
    f.refreshDataAndView = function (j) {
        ...
        if (i.location == "remote") {
            ...
            this._refreshSortingDataAndView({keepSelection: j, sorting: true})
        }
    };
    ...
    f._refreshSortingDataAndView = function (m) {
        var n = m.sorting, q = m.fn, i = m.keepSelection;
        if (!i) {
            this.sRows.removeAll({raiseEvent: true});
            this.sCells.removeAll({raiseEvent: true})
        }
        var s = this.options.dataModel, t = this.colModel, o = s.sortIndx, k = this.getColIndxFromDataIndx(o);
        if (o == null || k == null) {
            n = false
        }
        var j = s.sortDir;
    ...
    f._computeOuterWidths = function (l) {
        var k = this.options, n = k.columnBorders, j = this.colModel, p = j.length;
        for (var m = 0; m < p; m++) {
            var o = j[m];
    ...
    f._generateCellHighlighter = function (k, l, m, j, i) {
        if (this.$div_focus && this.$div_focus[0].offsetParent == k) {
            ...
            this.$div_focus.css({left: l, top: m, height: i, width: j})
        } else {
            if (this.$div_focus) {
                this.$div_focus.remove()
            }
    ...
    f.selectRow = function (k) {
        var j = k.rowIndx, i = k.evt, l = k.offset;
    ...
    f.bringRowIntoView = function (n) {
        ...
        if (p[0] == undefined) {
            ...
            var t = p[0].offsetTop + p[0].offsetHeight, k = this.$cont[0].offsetHeight, m = this._getScollBarHorizontalHeight();
            if (t > k - m) {
                var s = t - (k - m);
                ...
                this.$vscroll.pqScrollBar("option", {num_eles: v, cur_pos: q}).pqScrollBar("scroll")
            }
        }
    };
    f._bringCellIntoView = function (s) {
        var k = s.rowIndxPage, o = s.colIndx, p = false;
        var l;
        if (this.hidearrHS[o]) {
    ...
    f.selection = function (l) {
        var j = l.rowIndx, k = l.colIndx, m = l.method, i = l.type;
        if (i == "row") {
    ...
    f._setSelection = function (m) {
        ...
        var n = m.offset = (m.offset == null) ? this.getRowIndxOffset() : m.offset, k = m.rowIndx = (m.rowIndx == null) ? m.rowIndxPage + n : m.rowIndx, i = m.rowIndxPage = (m.rowIndxPage == null) ? m.rowIndx - n : m.rowIndxPage, l = m.colIndx, j = m.evt;
        if (i < 0 || l < 0) {
            return false
        }
        ...
        this.bringRowIntoView({rowIndxPage: i});
        if (l == null) {
            return this.selectRow({rowIndx: k, evt: j})
        }
        this._bringCellIntoView({rowIndxPage: i, colIndx: l});
        return this.selectCell({rowIndx: k, colIndx: l, evt: j})
    };
    f.saveEditCell = function () {
        if (this.$td_edit == null) {
            return
        }
        var j = this.$td_edit, p = this.getCellIndices(j), n = this.getRowIndxOffset(), k = p.colIndx, i = p.rowIndxPage, o = p.rowIndx = i + n, t = this.colModel, l = p.column = t[k], r = p.dataIndx = l.dataIndx, m = this.data[i][r];
        if (i != null) {
            ...
            if (s != m) {
                ...
                if (q.options.flexHeight) {
                    ...
                    q.bringRowIntoView({rowIndxPage: i})
                }
            }
        }
    };
    ...
    f._fixIEFooterIssue = function () {
        h(".pq-grid-footer").css({position: "absolute"});
        h(".pq-grid-footer").css({position: "relative"})
    };
    f.refreshColumn = function (l) {
        var o = this.options.customData, k = l.colIndx = (l.colIndx == null) ? this.getColIndxFromDataIndx(l.dataIndx) : l.colIndx, n = this.getRowIndxOffset();
    ...
    f.refreshCell = function (q) {
        ...
        var o = q.offset = (q.offset == null) ? this.getRowIndxOffset() : q.offset, p = q.rowIndx = (q.rowIndx == null) ? q.rowIndxPage + o : q.rowIndx, i = q.rowIndxPage = (q.rowIndxPage == null) ? q.rowIndx - o : q.rowIndxPage, r = q.dataIndx, k = q.colIndx = (q.colIndx == null) ? this.getColIndxFromDataIndx(r) : q.colIndx, j = q.$td = (q.$td == null) ? this.getCell(q) : q.$td, m = q.column = this.colModel[k], l = this.data[i];
        if (!l) {
            return
        }
        var n = q;
    ...
    f.refreshRow = function (q) {
        ...
        var s = this.options, o = q.offset = (q.offset == null) ? this.getRowIndxOffset() : q.offset, p = q.rowIndx = (q.rowIndx == null) ? q.rowIndxPage + o : q.rowIndx, i = q.rowIndxPage = (q.rowIndxPage == null) ? q.rowIndx - o : q.rowIndxPage, r = (q.$tr == null) ? this.getRow(q) : q.$tr, t = this.colModel, m = this.data[i];
        if (!m) {
            return
        }
        var n = {rowIndx: p, rowIndxPage: i, rowData: m, customData: s.customData};
    ...
    f.quitEditMode = function (i) {
        if (this.$td_edit) {
            ...
            this.disableSelection();
            this._setGridFocus();
            this._trigger("quitEditMode", i, {$td: j, dataModel: this.options.dataModel});
    ...
    f.getRowIndxOffset = function () {
        var j = this.options.dataModel, i = j.paging, m = 0;
        if (i == "local" || i == "remote") {
            var k = j.curPage;
            var l = j.rPP;
            m = (l * (k - 1))
    ...
    f.selectCell = function (l) {
        var j = l.rowIndx, k = l.colIndx, i = l.evt;
        if (i && (i.type == "keydown" || i.type == "keypress")) {
    ...
    f._editCell = function (j) {
        ...
        var i = o.rowIndxPage, m = this.getRowIndxOffset(), n = i + m, k = o.colIndx, l = this.colModel[k], q = l.dataIndx;
        if (this.$td_edit && this.$td_edit[0] == j[0]) {
            return false
        }
        this.$td_edit = j;
        ...
        this._removeCellRowOutline();
        this._generateCellRowOutline({$td: j});
        ...
        if (l.editor) {
            l.editor({$cell: r, data: this.data, dataModel: this.dataModel, rowIndx: n, rowIndxPage: i, colIndx: q})
        } else {
    ...
    f.getCell = function (k) {
        var i = (k.rowIndxPage == null) ? (k.rowIndx - this.getRowIndxOffset()) : k.rowIndxPage, j = k.colIndx;
        var l;
        if (this.$tbl != undefined) {
    ...
    f._getEditCellData = function (o) {
        var n = o.colIndx, i = o.rowIndxPage, k = (o.rowIndx != null) ? o.rowIndx : i + this.getRowIndxOffset(), j = (o.column) ? o.column : this.colModel[n], l = (o.$cell) ? o.$cell : this.$div_focus;
    ...
    f._incrIndx = function (i, l) {
        ...
        return {rowIndxPage: i, colIndx: l}
    };
    ...
    f.addColumn = function (m, n) {
        var l = this.options, j = l.colModel, p = l.dataModel.data;
        j.push(m);
        this._refreshHeader();
    ...
    f.keyPressDown = function (y) {
        var t = this, w = this.sCells.getSelection(), o = this.sRows.getSelection(), p = t.getRowIndxOffset(), k = t.options.selectionModel, q, l;
        var v = {
            left: 37,
            up: 38,
            right: 39,
        ...
        if (t.$td_edit) {
            var j = h(t.$td_edit[0]);
            var r = t.getCellIndices(j), i = r.rowIndxPage, q = i + p, l = r.colIndx, n = this.colModel[l], m = (n.editModel) ? n.editModel.saveKey : null;
            ...
            if (y.keyCode == v.tab) {
                ...
                if (this.options.selectionModel.type == "row") {
                    if (r.rowIndxPage != i) {
                        ...
                        t._setSelection({rowIndxPage: r.rowIndxPage})
                    }
                    t._bringCellIntoView({rowIndxPage: r.rowIndxPage, colIndx: r.colIndx})
                } else {
                    if ((r.rowIndxPage != i || r.colIndx != l) && this.options.selectionModel.type == "cell") {
                        t._setSelection(null);
                        t._setSelection({rowIndxPage: r.rowIndxPage, colIndx: r.colIndx})
                    }
                }
                i = r.rowIndxPage;
                l = r.colIndx;
                var x = this.getCell({rowIndxPage: r.rowIndxPage, colIndx: r.colIndx});
                if (x && x.length > 0) {
                    this._editCell(x)
                }
                y.preventDefault();
            ...
            if (o.length > 0 && k.type == "row") {
                var r = o[o.length - 1], q = r.rowIndx, i = q - p
            } else {
                if (w.length > 0 && k.type == "cell") {
                    var r = w[w.length - 1], q = r.rowIndx, i = q - p, u = r.dataIndx, l = this.getColIndxFromDataIndx(u);
                    if (q == null || l == null) {
                        return
                    }
        ...
        if (y.keyCode == v.left) {
            ...
            if (r) {
                t._setSelection({rowIndxPage: r.rowIndxPage, colIndx: r.colIndx, evt: y})
            }
            y.preventDefault();
            return
        } else {
            if (y.keyCode == v.right) {
                ...
                if (y.keyCode == v.tab) {
                    ...
                    if (y.keyCode == v.up) {
                        i = t._decrRowIndx(i);
                        if (r) {
                            t._setSelection({rowIndxPage: i, colIndx: l, evt: y})
                        }
                        y.preventDefault();
                        return
                    } else {
                        if (y.keyCode == v.down) {
                            ...
                            if (y.keyCode == v.pageDown || y.keyCode == v.spaceBar) {
                                ...
                                t._setSelection({rowIndx: q, colIndx: l, evt: y});
                                y.preventDefault();
                                return
                            } else {
                                        ...
                                        if (y.keyCode == v.end) {
                                            ...
                                            if (y.keyCode == v.enter) {
                                                if (this.options.selectionModel.type == "row") {
                                                    var s, j;
                                                    if (o.length > 0) {
                                                        t._editFirstCellInRow({rowIndxPage: i})
                                                    }
                                                } else {
                                                    if (w.length > 0) {
                                                        var j = this.getCell({rowIndxPage: i, colIndx: l});
                                                        if (j && j.length > 0) {
                                                            if (this.isEditableCell({colIndx: l})) {
                                                                t._editCell(j)
                                                            }
                                                        }
                                                    }
    ...
    f._setScrollVNumEles = function (t) {
        var q = this, o = this.$vscroll, v = o.pqScrollBar("option"), u = parseInt(v.num_eles), r = parseInt(v.cur_pos);
    ...
    f.nestedCols = function (t, s, u) {
        ...
        return {depth: o, colModel: p, colSpan: q, width: j, childCount: l}
    };
    f.getHeadersCells = function () {
        var s = this.options.colModel, A = this.colModel.length, B = this.depth;
        var j = [];
        for (var q = 0; q < B; q++) {
            j[q] = [];
            var y = 0;
    ...
    f.assignRowSpan = function () {
        var m = this.options.colModel, i = this.colModel.length, p = this.headerCells, k = this.depth;
        for (var j = 0; j < i; j++) {
            for (var r = 0; r < k; r++) {
                var o = p[r][j];
                if (j > 0 && o == p[r][j - 1]) {
    ...
    f._createHeader = function () {
        ...
        var H = [];
        var y = this.options, x = y.colModel, F = x.length, G = this.colModel, K = G.length, Q = this.depth, N = y.columnBorders, L = this.headerCells;
        if (Q >= 1) {
            I += "<tr>";
            if (this.numberCell) {
        ...
        this.$header.find("td").click(function () {
            ...
            var T = U.dataIndx;
            if (u._trigger("beforeSort", null, {dataModel: u.dataModel, data: u.data, sortIndx: T}) == false) {
                return
            }
            var S = "up";
            ...
            u._refreshSortingDataAndView({
                sorting: true, keepSelection: true, fn: function () {
                    u._trigger("sort", null, {dataModel: u.dataModel, data: u.data})
                }
            })
        });
        var R = 0;
    ...
    f._generateSummaryRow = function (q, p, u, E, w, n, B, z) {
        var r = "pq-summary-row", i = "", C = this.options.columBorders;
        ...
        var A = {rowIndx: p + n, rowIndxPage: p, rowData: q, summaryCell: true};
        for (var m = 0; m < E; m++) {
            var l = u[m], t = l.dataIndx;
            A.column = l;
            A.colIndx = m;
            var s = false;
    ...
    f._refreshOtherTables = function () {
        return;
        var z = this.colModel, v = z.length, t = this.options.columBorders;
        for (var s = 0; s < this.tables.length; s++) {
            var r = this.tables[s];
            var m = r.$tbl, u = m.find("tr:first");
            for (var o = 0; o < v; o++) {
                var p = z[o], w = p.dataIndx;
                if (p.hidden) {
